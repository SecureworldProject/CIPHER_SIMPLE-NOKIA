...
extern "C" _declspec(dllexport) int cipher(LPVOID out_buf, LPCVOID in_buf, DWORD size/*, XXX key*/);
extern "C" _declspec(dllexport) int decipher(LPVOID out_buf, LPCVOID in_buf, DWORD size/*, XXX key*/);
...
int cipher(LPVOID out_buf, LPCVOID in_buf, DWORD size/*, XXX key*/) {
    printf("Ciphering (%ws)\n", cipher_data->file_name);
...
int decipher(LPVOID out_buf, LPCVOID in_buf, DWORD size/*, XXX key*/) {
